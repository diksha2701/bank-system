                    ...
                    <form action="CODE.php" method="POST">
                        <div class="input-group mb-3">
                            <input type="text" id="enterName" class="form-control" placeholder="Recipient's username"
                                aria-label="Recipient's username" aria-describedby="basic-addon2" name ="username" >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ol id="transaction-history-body">
                       <?php
                       $check=mysqli_query($conn,"SELECT * FROM `transport`");
                ...
                <tbody>
                    <tr class="table-light">
                     ...
                     <tr class="table-info">
                        ...
                        <td>
                            <p id="RishabhBankBalance">164000</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td scope="row">3</td>
                        <td>Doli</td>
                        <td>doli@gmail.com</td>
                        <td>
                            <p id="DoliBankBalance">125000</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">4</td>
                        ...
                        <td>
                            <p id="LatikaBankBalance">340000</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td scope="row">5</td>
                        <td>Shaurabh</td>
                        <td>shaurabh@gmail.com</td>
                        <td>
                            <p id="ShaurabhBankBalance">607000</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">6</td>
                        <td>Hansraj</td>
                        <td>hansraj@gmail.com</td>
                        <td>
                            <p id="HarsrajBankBalance">450900</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td>7</td>
                        ...
                        <td>
                            <p id="KavyaBankBalance">780000</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">8</td>
                        ...
                        <td>
                            <p id="HussainBankBalance">200635</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td>9</td>
                        ...
                        <td>
                            <p id="DimpleBankBalance">100000</p>
                        </td>
                        </tr>
                        <tr class="table-info">
                            <td>10</td>
                            ...
                            <td>
                                <p id="ReenaBankBalance">500000</p>
                            </td>
                        </tr>
